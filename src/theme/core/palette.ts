...
export const button = createPaletteChannel(themeConfig.palette.button);
export const accent = createPaletteChannel(themeConfig.palette.accent);
...
export const colorKeys: {
  ...
  palette: ['primary', 'secondary', 'info', 'success', 'warning', 'error', 'button', 'accent'],
  common: ['black', 'white'],
};
